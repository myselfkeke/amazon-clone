...
export function renderOrderSummary() {
  ...
  cart.forEach((cartItem) => {
    ...
    // console.log(matchingProduct);  --> why this console log logs the cart products twice on the console?

    const deliveryOptionId = cartItem.deliveryOptionsId;
    const deliveryOption = getDeliveryOption(deliveryOptionId);
    // console.log(deliveryOption); //-->  --> why this console log logs the delivery option twice on the console?
